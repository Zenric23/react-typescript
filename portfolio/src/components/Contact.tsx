...
const Contact = () => {
  ...
  return (
    <div className={`${dark ? 'after:bg-gray-800' : 'after:bg-white'} grid md:grid-cols-3 gap-10 relative project-image-card-reverse items-center`} id="contact">
      <img
        src={pic}
        alt=""
        className="h-[340px] w-[340px] hover:rotate-[-20deg] transition duration-300 cursor-pointer z-10 hidden md:inline"
      />
      <div className="p-10 bg-white dark:bg-gray-700 rounded-xl md:col-span-2 shadow-2xl z-10">
